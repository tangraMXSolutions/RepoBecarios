...
<html>
    ...
    <body>
        ...
        <form id="frmSurtidoEtapa3" method="post" name="frmSurtidoEtapa3" action="ServiceTracker" >
            <div id="container">
                    <table style="margin: 1px;padding: 1px;width: 10%;">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <input type="hidden" name="accion" id="accion" value="CONTINUAR_SURTIDO_ETAPA2" />
