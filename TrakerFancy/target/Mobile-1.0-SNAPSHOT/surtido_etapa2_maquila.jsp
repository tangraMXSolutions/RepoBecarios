...
<html>
    ...
    <body>
        ...
        <form id="frmSurtidoEtapa2Maquila" method="post" name="frmSurtidoEtapa2Maquila" action="ServiceTracker" >
            <div id="container">
                    ...
                    <table style="margin: 1px;padding: 1px;width: 10%;">
                        ...
                        <tr><td colspan="2"><label id="lblMensaje" class="error"><%=mensaje%></label></td></tr>
                         <tr>
                            ...
                            <input type="hidden" name="accion" id="accion" value="CONTINUAR_SURTIDO_ETAPA1_MAQUILA" />                      
            </div>
        </form>
