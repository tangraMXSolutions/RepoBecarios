...
<html>
    ...
    <body>
        ...
        <form id="frmSurtidoEtapa1Maquila" method="post" name="frmSurtidoEtapa1Maquila" action="ServiceTracker">
            <table style="margin: 1px;padding: 1px;width: 10%;">
                <tr>
                    <td align="left"><label class="textoPequenoMenu">Pedido:</label>
                        <select style="z-index: 0;" onchange="selectValorComboMaquilaEtapa1(this, 'cbPedido', 'frmSurtidoEtapa1Maquila');" >
            ...
            <input type="hidden" name="accion" id="accion" value="SURTIDO_ETAPA1_MAQUILA" />
