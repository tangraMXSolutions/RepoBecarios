<%-- 
    Document   : inventario_sku
    Created on : 18/07/2016, 11:00:24 PM
    Author     : Emmanuel
--%>
    ...
    <body>
        ...
        <form id="frmInventarioActivos" method="post" name="frmInventarioActivos" action="ServiceTracker">
            <table style="margin: 1px;padding: 1px;width: 10%;">
                ...
                <tr><td colspan="2"><label>SKU:</label> <input  type="text" id="elpn" name="elpn" onchange="document.forms[0].submit()"></td></tr>


                <input type="hidden" name="accion" id="accion" value="INVENTARIO_EXISTENCIA" />
                <input type="hidden" name="accion2" id="accion2" value="1" />
            ...
            %>
            <label class="bien"><%=(String) ((formInventario.getPosicion() != "") ? "Productos encontrados con sku "+formInventario.getPosicion()+" , Total  "+formInventario.getCantidad() : "")%></label>
            <table style="margin: 2px;padding: 4px;width: 50%;">
                ...
                <tr>
                    ...
                    <td><%=listado.getElpn()%></td>
                    <td><%=listado.getLocalidad()%></td>
                </tr>
                <% }%></table>
                <%
                } else {%>
            <label class="error"><%=(String) ((formInventario.getPosicion() != "") ? " No Hay Productos en el inventario con el sku : " + formInventario.getPosicion() : "")%></label>
            <%}
