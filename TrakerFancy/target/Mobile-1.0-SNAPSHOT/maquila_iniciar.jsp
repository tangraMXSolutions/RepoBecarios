<%-- 
    Document   : maquila_iniciar
    Created on : 12/08/2016, 01:26:16 AM
    Author     : Emmanuel
--%>
    ...
    <body>
        ...
        <form id="frmAsociacionMaquila" method="post" name="frmAsociaconMaquila" action="ServiceTracker">
            ...
            <table style="margin: 1px;padding: 1px;width: 10%;">
                ...
                <tr>
                    <td align="left">Lote de producto terminado</td>
                    <td align="left"><input value="<%=formMaquila.getLote() %>" id="txtLote" name="txtLote"/>
                    </td>
                </tr>
                <tr>
                    <td align="left">Charolas</td>
                    <td align="left"><input value="<%=formMaquila.getCharolas() %>" id="txtCharolas" name="txtCharolas"/>
                    </td>
                </tr>
                <tr>
                    <td align="left">Packs</td>
                    <td align="left"><input value="<%=formMaquila.getPacks() %>" id="txtPacks" name="txtPacks"/>
                    </td>
                </tr>
                <tr>
                    <td align="left">No Pallet / LPN </td>
                    <td align="left"><input value="<%=formMaquila.getNoPallets() %>" id="txtNoPallet" name="txtNoPallet"/>
                    </td>
                </tr>
                <tr>
                ...
                <td algin="left"><input  style="z-index: 6;" id="submit" type="submit" onclick="iniciarMaquilaRegistro('frmAsociacionMaquila');return false;" value="REGISTRAR"></td>       
            </table>
